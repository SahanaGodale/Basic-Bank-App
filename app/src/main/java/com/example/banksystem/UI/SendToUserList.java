...
import com.example.banksystem.DB.TransactionHelper;
import com.example.banksystem.DB.UserHelper;
import com.example.banksystem.Data.User;
import com.example.banksystem.ListAdapters.SendToUserAdapter;
import com.example.banksystem.R;
import com.example.banksystem.DB.TransactionContract.TransactionEntry;
...
public class SendToUserList extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    ...
    public void onUserClick(int position) {
        ...
        startActivity(new Intent(SendToUserList.this, Home_Activity.class));
        finish();
    }
